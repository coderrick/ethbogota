...
async function printCreate(structLog, index, structLogs, dependencies) {
    ...
    const str = await (0, contract_1.formatContract)(codeWithArgs, value, null, deployedAddress, dependencies);
    console.log(constants_1.DEPTH_INDENTATION.repeat(structLog.depth) +
        (0, colors_1.colorLabel)("CREATE") +
        " " +
        str +
        (0, print_gas_cost_1.printGasCost)(structLog, null, dependencies));
    return deployedAddress;
}
exports.printCreate = printCreate;
